...
(describe
 ...
 (it "should not eta-reduce self-recoursive functions"
     ...
     (check ((args1 (gen-arg-list (gen-integer 0 5)))
             ...
             (body1 (apply gen-app-node op2 args1))
             (fun1 (gen-lambda-node args1 body1))
             (binding1 (gen-with-bv (gen-binding-node op1 fun1)
                                    (set var1)))
             (args2 (gen-arg-list (gen-integer 0 5)))
             (body2 (apply gen-app-node op1 args2))
             (fun2 (gen-lambda-node args2 body2))
             (binding2 (gen-with-bv (gen-binding-node op2 fun2)
                                    (set var2)))
